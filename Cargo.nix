  ...
  internal = rec {
    ...
    crates = {
      ...
      "shigoto" = rec {
        ...
        version = "0.1.4";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./shigoto; };
        authors = [
          "pleme-io"
        ];
        dependencies = [
      ...
      "shigoto-budget" = rec {
        ...
        version = "0.1.4";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./shigoto-budget; };
      ...
      "shigoto-dag" = rec {
        ...
        version = "0.1.4";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./shigoto-dag; };
        libName = "shigoto_dag";
        authors = [
          "pleme-io"
        ];
      ...
      "shigoto-emit" = rec {
        ...
        version = "0.1.4";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./shigoto-emit; };
      ...
      "shigoto-gate" = rec {
        ...
        version = "0.1.4";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./shigoto-gate; };
      ...
      "shigoto-retry" = rec {
        ...
        version = "0.1.4";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./shigoto-retry; };
      ...
      "shigoto-scheduler" = rec {
        ...
        version = "0.1.4";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./shigoto-scheduler; };
      ...
      "shigoto-test" = rec {
        crateName = "shigoto-test";
        version = "0.1.4";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./shigoto-test; };
        libName = "shigoto_test";
        authors = [
          "pleme-io"
        ];
        dependencies = [
      ...
      "shigoto-types" = rec {
        ...
        version = "0.1.4";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./shigoto-types; };
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "macros" "rt" "rt-multi-thread" "sync" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
